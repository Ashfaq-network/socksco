...
(name, slug, description, price_per_pair, bundle_price, bundle_size, moq, images, colors, sizes, stock, category_id, subcategory_id, is_featured, is_new, is_best_seller) values
('Classic Crew Sock', 'classic-crew-sock',
 ...
 ARRAY['#2C3E5C','#3C4148','#F7F8FA'], ARRAY['S','M','L','XL'], 500,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='full'), true, true, true),
...
('Formal Dress Sock', 'formal-dress-sock',
 ...
 ARRAY['#3C4148','#2B2F35'], ARRAY['S','M','L'], 400,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='full'), true, true, false),
...
('Everyday Ankle Sock', 'everyday-ankle-sock',
 ...
 ARRAY['#26282B','#2C3E5C','#F7F8FA'], ARRAY['S','M','L','XL'], 600,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='ankle'), false, true, true),
...
('No-Show Liner', 'no-show-liner',
 ...
 ARRAY['#E8B4BC','#F7F8FA','#B9A7D9'], ARRAY['XS','S','M','L'], 450,
 (select id from public.categories where slug='women'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='women' and s.slug='ankle'), false, true, false),
...
('Pastel Crew Sock', 'pastel-crew-sock',
 ...
 ARRAY['#B9A7D9','#E8B4BC','#7FB8E0'], ARRAY['S','M','L'], 380,
 (select id from public.categories where slug='women'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='women' and s.slug='full'), true, false, true),
...
('Knee-High Sock', 'knee-high-sock',
 ...
 ARRAY['#E88A7A','#7FB8E0','#2C3E5C'], ARRAY['S','M','L'], 350,
 (select id from public.categories where slug='women'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='women' and s.slug='full'), false, true, false),
...
('School Sock', 'school-sock',
 ...
 ARRAY['#F7F8FA','#4A6FA5'], ARRAY['Kids 3-5','Kids 6-9','Kids 10-13'], 700,
 (select id from public.categories where slug='school-socks'), null, true, false, true),
...
('Toddler Ankle Sock', 'toddler-ankle-sock',
 ...
 ARRAY['#7FB8E0','#F0B429','#5BB7A9'], ARRAY['Toddler 6-12m','Toddler 1-3y','Kids 3-5'], 520,
 (select id from public.categories where slug='baby'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='baby' and s.slug='unisex'), false, true, false),
...
('Colorful Knee-High (Kids)', 'colorful-knee-high-kids',
 ...
 ARRAY['#5BB7A9','#F2A65A','#E88A7A'], ARRAY['Kids 6-9','Kids 10-13'], 420,
 (select id from public.categories where slug='childrens'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='childrens' and s.slug='party-socks'), false, false, false),
...
('Running Performance Sock', 'running-performance-sock',
 ...
 ARRAY['#223A5E','#E2572C','#26282B'], ARRAY['M','L','XL'], 300,
 (select id from public.categories where slug='sports-socks'), null, true, true, true),
...
('Football Grip Sock', 'football-grip-sock',
 ...
 ARRAY['#5E8A3A','#223A5E','#26282B'], ARRAY['M','L','XL'], 280,
 (select id from public.categories where slug='sports-socks'), null, false, true, false),
...
('Tennis Quarter Sock', 'tennis-quarter-sock',
 ...
 ARRAY['#F3F4F6','#223A5E'], ARRAY['S','M','L','XL'], 360,
 (select id from public.categories where slug='sports-socks'), null, false, false, false),
...
('Argyle Crew Sock', 'argyle-crew-sock',
 ...
 ARRAY['#D9A441','#6B4E1F','#3C4148'], ARRAY['M','L'], 260,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='half'), true, false, true),
...
('Cozy Knit Sock', 'cozy-knit-sock',
 ...
 ARRAY['#C46A4A','#8B8E96','#6B4E1F'], ARRAY['S','M','L','XL'], 320,
 (select id from public.categories where slug='women'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='women' and s.slug='full'), true, true, false),
...
('Loafer Crew Sock', 'loafer-crew-sock',
 ...
 ARRAY['#8B8E96','#3C4148','#2C3E5C'], ARRAY['S','M','L','XL'], 410,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='ankle'), false, false, false),
...
('Fine Rib Dress Sock', 'fine-rib-dress-sock',
 ...
 ARRAY['#1F3A5F','#2B2F35','#3C4148'], ARRAY['S','M','L'], 340,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='full'), true, false, true),
...
('Executive Micro-Stripe Sock', 'executive-micro-stripe-sock',
 ...
 ARRAY['#2B2F35','#1F3A5F'], ARRAY['M','L'], 310,
 (select id from public.categories where slug='men'), (select id from public.subcategories s join public.categories c on c.id = s.category_id where c.slug='men' and s.slug='full'), false, false, false);
