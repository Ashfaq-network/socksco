export default function WhatsAppButton({ number = '94770000000' }) {
  return (
    <a
      href={`https://wa.me/${number}?text=${encodeURIComponent('Hi Socks Co! I would like to know more about your wholesale socks.')}`}
      target="_blank"
